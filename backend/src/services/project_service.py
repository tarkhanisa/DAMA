...
class ProjectTypeDefinition:
    """Supported project type metadata."""
...
class ProjectMetadata:
    """Normalized project metadata without database persistence."""
...
class ProjectService:
    """
    Service layer for project-oriented content workflows.

    This service does not persist data yet.
    It only prepares normalized project metadata and project type definitions.
    """
    ...
    def build_project_metadata(
        ...
        *,
        ...
        """
        Build normalized project metadata.

        This method does not save anything to a database.
        It prepares the future shape of project records.
        """
        ...
        if not normalized_language:
            raise InvalidProjectRequestError("Project language cannot be empty.")
    ...
    def _get_project_type_definition(cls, key: str) -> ProjectTypeDefinition:
        ...
        raise InvalidProjectRequestError(
            f"Unsupported project type key: {normalized_key}"
        )
